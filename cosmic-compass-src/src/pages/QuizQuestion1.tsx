        ...
        >
          ...
          >
            {[1, 2, 3, 4].map((step) => (
              <div
                key={step}
                className={`w-8 sm:w-12 lg:w-32 h-1 lg:h-3 rounded-full ${step === 1 ? "bg-neon-cyan" : "bg-muted"
                  }`}
              />
            ))}
          </motion.div>
          ...
          >
            ...
            <h1 className="font-orbitron text-lg sm:text-xl md:text-2xl lg:text-5xl xl:text-6xl font-bold text-foreground mt-2 sm:mt-6">
