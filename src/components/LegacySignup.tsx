...
export default function LegacySignup({ isEmbedded = false }: { isEmbedded?: boolean }) {
  ...
  return (
    <div className={isEmbedded ? "loginEmbedded" : "loginWrapper"}>
        ...
        <div style={{ marginTop: '20px', textAlign: 'center', color: 'rgba(255,255,255,0.5)', fontSize: '0.8rem', cursor: 'pointer' }} onClick={() => router.push('/login')}>
