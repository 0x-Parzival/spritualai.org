...
// Use global CSS for shared effects (Ocean, Neon, Lotus)
// We assume landing.css is imported in layout or page.tsx
...
export default function MobileHome() {
    ...
    useEffect(() => {
        ...
        // Targeting global classes (ensure no conflicts or scoped correctly if possible)
        // Since we are "mobile view", desktop view is hidden, so targeting .segmR is safe.
    ...
    return (
        <div className={styles.mobileWrapper}>
            ...
            <div className="ocean-main" style={{ position: 'absolute', zIndex: 1, bottom: 0, height: '50vh', width: '100%', pointerEvents: 'none' }}>
                <div className="ocean">
            ...
            <header className={styles.header}>
                <div className="neon" style={{ transform: 'scale(0.5)', transformOrigin: 'center top', margin: 0 }}>
                    <div className="title">
            ...
            <main className={styles.mainContent}>
                ...
                <div className={styles.lotusWrapper}>
                    ...
                    <div className="flower-container mobile-lotus" style={{ transform: 'scale(0.7)' }}>
