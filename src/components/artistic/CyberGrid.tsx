...
export default function CyberGrid() {
    ...
    useEffect(() => {
        ...
        const CONFIG = {
            ...
            // Colors
            color1: new THREE.Color('#7ae4ff'),
            color2: new THREE.Color('#a5a3ff'),
            color3: new THREE.Color('#c8ff00'),
            color4: new THREE.Color('#ff007b'),
            activeColors: new THREE.Vector4(1, 0, 0, 0),
        ...
        const mesh = new THREE.LineSegments(
            ...
            new THREE.ShaderMaterial({
                ...
                uniforms: {
                    ...
                    uActiveColors: { value: CONFIG.activeColors },
