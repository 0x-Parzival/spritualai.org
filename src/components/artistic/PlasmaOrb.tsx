...
export default function PlasmaOrb() {
    ...
    useEffect(() => {
        ...
        const params = {
            ...
            colorDeep: new THREE.Color(0x001433),      // Color Deep
            colorMid: new THREE.Color(0x0084ff),       // Color Mid
            colorBright: new THREE.Color(0x00ffe1),    // Color Bright
            
            // Shell
            shellColor: new THREE.Color(0x0066ff),     // Edge Color
