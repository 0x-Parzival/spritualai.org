...
const NeonLotus = dynamic(() => import("../components/NeonLotus"), {
    ssr: false,
});
...
export default function Home() {
    ...
    // const stars2Ref = useRef<HTMLDivElement>(null); // Removed stars
    // const stars3Ref = useRef<HTMLDivElement>(null); // Removed stars
    // const oceanRef = useRef<HTMLDivElement>(null); // Removed ocean

    useEffect(() => {
        // ---------------- STAR GENERATION REMOVED ----------------
        // ---------------- MOUSE MOVEMENT TILT REMOVED (Ocean) ----------------
    ...
    return (
        <>
            ...
            >
                <NeonLotus />
                {/* 🌌 Main Background Optimized - REMOVED */}
                ...
                {/* 🕉️ Shiva Background Optimized - REMOVED */}
                ...
                <div style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', zIndex: 0, pointerEvents: 'none' }}>
                    <UnicornScene
                        projectId="RLWaeyqnj1FXWiQF8psq"
                    ...
                    <div className="neon">
                        <div className="title">
                            ...
                            <div className="subtitle-lotus-container">
                                ...
                                <h3 className="subheading-text" style={{ fontSize: '1rem', textTransform: 'none', letterSpacing: '0.03em', marginTop: '0.5rem', color: 'rgba(255, 255, 255, 0.8)', fontWeight: '400' }}>
